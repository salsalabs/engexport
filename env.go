...
<<<<<<< HEAD
		"phone_number_type_1",
=======
>>>>>>> 74ad304f8e256b028a515031506f23a8ec9804a4
		"phone_number_type_2",
		"pref_method_contact",
		...
		"gender_supporter",
		"martial_status_supporter",
		"family_being_helped_other_1",
		"phone_secondary",
		"phone_secondary_type",
		"account_name",
...
//NewAllSupporter instantiates an envionrment to copy active supportes to
//CSV files.  Active supporters have a good email address and have not opted out
//or been opted out (i.e. Receive_Email > 0).
func NewAllSupporter(api *godig.API, dir string) *E {
	e := NewSupporter(api, dir)
	e.Conditions = []string{}
	return e
}
